...
public class Task3_keyPress extends Application{
...
//    public void Calculator(TextField lable_num, TextField lable_value, Text lable_price, double record){ }
    ...
    public void start(Stage primaryStage){
        ...
        num1.setOnKeyPressed(e ->Calculator1());
        num2.setOnKeyPressed(e -> Calculator2());
        num3.setOnKeyPressed(e -> Calculator3());
        value1.setOnKeyPressed(e -> Calculator1());
        value2.setOnKeyPressed(e -> Calculator2());
        value3.setOnKeyPressed(e -> Calculator3());
    }
